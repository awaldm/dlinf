...
$(TEST_LINEAR_TARGET): $(TEST_LINEAR_SOURCES) | $(BUILD_DIR)
	$(CXX) $(CXXFLAGS) -Iinclude -I$(EIGEN_INCLUDE) $(TEST_LINEAR_SOURCES) -o $(TEST_LINEAR_TARGET)

$(TEST_CONV_TARGET): $(TEST_CONV_SOURCES) | $(BUILD_DIR)
	$(CXX) $(CXXFLAGS) -Iinclude -I$(EIGEN_INCLUDE) $(TEST_CONV_SOURCES) -o $(TEST_CONV_TARGET)
